  ...
  return (
    <>
      <div className="w-full h-[100%] background text-amber-50">
        <Header />
        <div className="flex pt-[80px] lg:pt-[150px] pl-[20px] lg:pl-[40px] relative">
          <div className="w-full lg:w-[50%]">
            <h1 className="text-[15px] lg:text-[45px] ">
              <span className="text-[20px] lg:text-[60px] text-[#16fe01] font-bold">
                TRAVEL-X
              </span>{" "}
              CAR RENTAL <br />
              SERVICE IN ETHIOPIA
            </h1>
            <p className="text-[13px]/5 lg:text-[30px]/10 my-3 lg:my-6">
          ...
          <div className="w-[60%] flex">
            <img
              src="mercedis.png"
              className="w-[200px] lg:w-[700px] h-fit absolute right-[10px] hover:scale-10 hover:transition-1s"
              alt="Mercedis"
            />
          </div>
        </div>

        <div className="w-full mt-20 lg:mt-50 flex justify-between">
          <div className="w-[60%] lg:w-[50%] pl-[20px] lg:pl-10">
            <h1 className="text-[10px] lg:text-[40px] text-center font-bold">
              WELCOME TO THE BEST CAR RENTAL SERVICE IN TOWN.
            </h1>
            <h1 className="text-[10px] text-center lg:text-[22px] text-[#16fe01] py-2">
              The Quality Customer Service You Deserve
            </h1>
            <p className="text-[12px] text-center lg:text-[18px]">
          ...
          <div className="w-[40%] lg:w-[50%] flex justify-center">
            <img
              src="MersedisFront.png"
              className="w-[150px] mt-13 lg:mt-5 lg:w-[400px] h-fit"
              alt=""
              srcset=""
            />
          </div>
        ...
        <div className="mt-[100px] lg:mt-[200px] px-5 lg:px-20 flex justify-between items-center">
